...
class SimplyEco {
	...
	/**
	 * AddItem
	 * @param {{GuildID: string, ItemName: string, Price: number, SellPrice: number, user: User }} 
	 * param ItemName Name of the item
	 * param Price Price of the to be added Item
	 * param SellPrice Selling price of the to be added Item
	 */
	async AddItem({ GuildID, ItemName, Price, SellPrice, user }) {
